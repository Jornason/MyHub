 ...
 *
 * This class holds one example used to train a decision tree. It is also used
 * to represent instances that have not yet been classified and test instances
 * which are being used to judge the tree. */
#ifndef EXAMPLE_H_
#define EXAMPLE_H_
#include<vector>
using namespace std;
