...
void View::initialize()
{
    ...
    modelview = glm::lookAt(glm::vec3(600,600,600),glm::vec3(0,0,0),glm::vec3(0,1,0));
    ...
    scene = ObjectXMLReader::readObjectXMLFile("locomotive-lights-textures.txt", modelViewLocation, modelview, normalMatrixLocation, mat_ambientLocation, mat_diffuseLocation, mat_specularLocation, mat_shininessLocation, textureMap, textureLocation, textureMatrixLocation);
