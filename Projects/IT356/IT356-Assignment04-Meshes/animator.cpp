...
glm::mat4& Animator::animateThis(string& name, glm::mat4& transformationMatrix)
{
  if(name.compare("object") == 0)
  {
    ...
    if(name.compare("airplane")==0)
    {
        ...
        transformationMatrix = glm::rotate(glm::mat4(1.0), 20.0f , glm::vec3(0,0,1)) * transformationMatrix;
    ...
    if(name.compare("sun")==0)
    {
        ...
        transformationMatrix = glm::translate(glm::mat4(1.0), glm::vec3(15000,0,0)) * transformationMatrix;

        transformationMatrix = glm::rotate(glm::mat4(1.0), -rotationAngle, glm::vec3(0,0,1)) * transformationMatrix;
